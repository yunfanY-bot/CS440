...
class Agent:
    ...
    def act(self, environment, points, dead):
        ...
        for each_action in self.actions:
            ...
            if self.Ne <= N_Table:
                f = self.Q[n_fdx][n_fdy][n_awx][n_awy][n_abt][n_abb][n_abl][n_abr][each_action]
                if f >= max_f:
                    max_f = f
                    action = each_action
            else:
    ...
    def generate_state(self, environment):
        ...
        if snake_head_x == grid_size:
            adjoining_wall_x = 1
        elif snake_head_x == utils.DISPLAY_SIZE - 2*grid_size:
            adjoining_wall_x = 2
        else:
            adjoining_wall_x = 0
        ...
        if snake_head_y == grid_size:
            adjoining_wall_y = 1
        elif snake_head_y == utils.DISPLAY_SIZE - 2*grid_size:
            adjoining_wall_y = 2
        else:
            adjoining_wall_y = 0
