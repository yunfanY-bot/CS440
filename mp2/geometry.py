...
"""
helper func to check circle touch wall
"""
...
"""
helper func to check rect touch wall
"""


def does_alien_touch_wall_single_rect(head_tail, pos, r, length, g, wall):
...
def does_alien_touch_wall_single(alien, wall, granularity):
    ...
    if alien.is_circle():
        ...
        head = head_tail[0]
        tail = head_tail[1]
        return does_alien_touch_wall_single_rect(head_tail, pos, r, alien.get_length(), granularity, wall) \
               or does_alien_touch_wall_single_circle(head, r, granularity, wall) \
               or does_alien_touch_wall_single_circle(tail, r, granularity, wall)
